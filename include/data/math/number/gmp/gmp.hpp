...
namespace data::math {
    ...
    template <hex_case zz> division<hex::int1<zz>, hex::uint<zz>> divide<hex::int1<zz>, hex::int1<zz>>::operator ()
    ...
    division<hex::int1<zz>, hex::uint<zz>> divide<hex::int1<zz>, hex::uint<zz>>::operator ()

...
namespace data {
    ...
    namespace meta {
        ...
        struct for_each_map {
            ...
            using list_function = typename Which<for_each_list<entry_function<key, function, value>, list>, for_each_list<value_function<key, function, value>, list>>::result;
            using inner_function = decltype(list_function::Function);
            ...
            output operator()(const function f, const from m) const {
                return {list_function{}(inner_function{f}, map::entries(m))};
            }
        };
        
        template <typename function, typename from> 
        struct for_each {
            using inner_function = typename Which<for_each_list<function, from>, for_each_map<function, from>>::result;

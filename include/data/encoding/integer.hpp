...
namespace data::encoding::hexidecimal {
    ...
    template <hex::letter_case cx> 
    integer<math::number::ones, cx> inline operator+(const integer<math::number::ones, cx> &n, const integer<math::number::nones, cx> &m) {
    ...
    namespace {
        template <math::number::complement n, hex::letter_case zz> struct read_dec_integer {
            integer<n, zz> operator()(const std::string &x) {
                if (decimal::valid(x)) {
                    ...
                    return math::number::trim(integer<n, zz>{math::number::extend(z, z.size() + 1)});
                }
        ...
        template <hex::letter_case zz> struct read_dec_integer<math::number::nones, zz> {
            integer<math::number::nones, zz> operator()(const std::string &x) {
                ...
                if (np == nullptr) throw std::invalid_argument{std::string{"invalid number string"} + std::string{x}};
...
namespace data::encoding::hexidecimal {
    ...
    integer<math::number::ones, cx> inline operator-(const integer<math::number::ones, cx> &x) {
        if (!x.valid()) throw std::invalid_argument{"invalid hex integer"};
        return math::number::increment(~x);
    }
    ...
    namespace {
        ...
        template <hex::letter_case zz> struct write_int<math::number::nones, zz> {
            integer<math::number::nones, zz> operator()(int64 i) {
                ...
                return integer<math::number::nones, zz>{write_arith<zz>(endian::arithmetic<false, endian::big, 8>{static_cast<uint64>(i)})};
            }
        };
        
        template <hex::letter_case zz> struct write_int<math::number::ones, zz> {
            integer<math::number::ones, zz> operator()(int64 i) {
                return integer<math::number::ones, zz>{write_arith<zz>(endian::arithmetic<true, endian::big, 8>{i})};
            }
        };
        ...
        private:
            integer<math::number::twos, zz> write_uint(int64 i) {
                return integer<math::number::twos, zz>{write_arith<zz>(endian::arithmetic<false, endian::big, 8>{static_cast<uint64>(i)})};
            } 
        };
    }
...
namespace data::encoding::hexidecimal {
    ...
    namespace {
        ...
        integer<math::number::ones, zz> minus(const integer<math::number::ones, zz> &a, const integer<math::number::ones, zz> &b) {
            if (a.size() < b.size()) return minus(b, a);
            integer<math::number::ones, zz> n{};
            n.resize(a.size() + 2);
            minus(n, a, math::number::extend(b, a.size()));
            return n;
    ...
    integer<math::number::twos, zz> &operator++(integer<math::number::twos, zz> &x) {
        if (!x.valid()) throw std::invalid_argument{std::string{"invalid hexidecimal string: \""} + (std::string)(x) + "\""}; 
        if (math::number::is_negative(x)) return x = -math::number::decrement(-x);
    ...
    template <hex::letter_case zz> 
    integer<math::number::twos, zz> &operator--(integer<math::number::twos, zz> &x) {
        if (math::number::is_negative(x)) return x = -data::math::number::increment(-x);
    ...
    integer<c, zz> inline operator<<(const integer<c, zz> &a, int i) {
        if (!a.valid()) throw std::invalid_argument{std::string{"invalid hexidecimal string: \""} + (std::string)(a) + "\""}; 

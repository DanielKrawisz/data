...
public:
    ...
    public:
        ...
        iterator friend operator + (difference_type a, iterator b) {
            return iterator (b.ptr + a);
        }
    ...
    public:
        ...
        const_iterator friend operator + (difference_type a, const_iterator b) {
            return const_iterator (b.ptr + a);
        }
...
public:
    ...
    prevector (InputIterator b, InputIterator e) : _size (0) {
        size_type n = static_cast<size_type> (e - b);
        change_capacity (n);
        while (b != e) {
            _size++;
            new (static_cast<void *> (item_ptr (static_cast<difference_type> (size () - 1)))) T (*b);
            ++b;
        }
    }
    ...
    size_t capacity () const {
        if (is_direct ()) return N;
        else return _union.capacity;
    }
    ...
    size_t allocated_memory () const {
        if (is_direct ()) return 0;
        else return ((size_t) (sizeof (T))) * _union.capacity;
    }

...
namespace data::encoding {
    ...
    TEST (IntegerFormatTest, TestWriteNumbersZ) {
        ...
        EXPECT_EQ (encoding::hexidecimal::write<hex_case::lower> (Z_bytes_BC_big::read ("0")), std::string {"0x"});
        EXPECT_EQ (encoding::hexidecimal::write<hex_case::lower> (Z_bytes_BC_big::read ("-1")), std::string {"0x81"});
        EXPECT_EQ (encoding::hexidecimal::write<hex_case::lower> (Z_bytes_BC_big::read ("-2")), std::string {"0x82"});
        EXPECT_EQ (encoding::hexidecimal::write<hex_case::lower> (Z_bytes_BC_big::read ("127")), std::string {"0x7f"});
        EXPECT_EQ (encoding::hexidecimal::write<hex_case::lower> (Z_bytes_BC_big::read ("128")), std::string {"0x0080"});
        EXPECT_EQ (encoding::hexidecimal::write<hex_case::lower> (Z_bytes_BC_big::read ("-128")), std::string {"0x8080"});
        EXPECT_EQ (encoding::hexidecimal::write<hex_case::lower> (Z_bytes_BC_big::read ("-129")), std::string {"0x8081"});

        EXPECT_EQ (encoding::hexidecimal::write<hex_case::lower> (Z_bytes_BC_little::read ("0")), std::string {"0x"});
        EXPECT_EQ (encoding::hexidecimal::write<hex_case::lower> (Z_bytes_BC_little::read ("-1")), std::string {"0x81"});
        EXPECT_EQ (encoding::hexidecimal::write<hex_case::lower> (Z_bytes_BC_little::read ("-2")), std::string {"0x82"});
        EXPECT_EQ (encoding::hexidecimal::write<hex_case::lower> (Z_bytes_BC_little::read ("127")), std::string {"0x7f"});
        EXPECT_EQ (encoding::hexidecimal::write<hex_case::lower> (Z_bytes_BC_little::read ("128")), std::string {"0x0080"});
        EXPECT_EQ (encoding::hexidecimal::write<hex_case::lower> (Z_bytes_BC_little::read ("-128")), std::string {"0x8080"});
        EXPECT_EQ (encoding::hexidecimal::write<hex_case::lower> (Z_bytes_BC_little::read ("-129")), std::string {"0x8081"});

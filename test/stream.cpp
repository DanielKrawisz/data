...
namespace {
    ...
    TEST_F (Stream, WriteUint16Little) {
        iterator_writer writer (sliceTestWrite.begin (), sliceTestWrite.end ());
    ...
    TEST_F (Stream, WriteInt16Little) {
        iterator_writer writer (sliceTestWrite.begin (), sliceTestWrite.end ());
    ...
    TEST_F (Stream, SliceWriteUint32Big) {
        iterator_writer writer (sliceTestWrite.begin (), sliceTestWrite.end ());
    ...
    TEST_F (Stream, WriteUint32Little) {
        iterator_writer writer (sliceTestWrite.begin (), sliceTestWrite.end ());
    ...
    TEST_F (Stream, WriteInt32Little) {
        iterator_writer writer (sliceTestWrite.begin (), sliceTestWrite.end ());
    ...
    TEST_F (Stream, WriteUint64Little) {
        iterator_writer writer (sliceTestWrite.begin (), sliceTestWrite.end ());
    ...
    TEST_F (Stream, WriteInt64Little) {
        iterator_writer writer (sliceTestWrite.begin (), sliceTestWrite.end ());
    ...
    TEST_F (Stream, ReadUint16Little) {
        iterator_reader reader (sliceTestRead.begin (), sliceTestRead.end ());
    ...
    TEST_F (Stream, ReadUint32Little) {
        iterator_reader reader (sliceTestRead.begin (), sliceTestRead.end ());
    ...
    TEST_F (Stream, ReadUint64Little) {
        iterator_reader reader (sliceTestRead.begin (), sliceTestRead.end ());
    ...
    TEST_F (Stream, GetPositiveRange) {
    ...
    TEST_F (Stream, ReadUpToNegative) {
    ...
    TEST_F (Stream, ReadNegativeToEnd) {
